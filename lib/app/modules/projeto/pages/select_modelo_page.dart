...
class SelectModeloPage extends StatefulWidget {
  const SelectModeloPage({super.key});

  @override
  State<SelectModeloPage> createState() => _SelectModeloPageState();
}

class _SelectModeloPageState extends State<SelectModeloPage> {
    ...
    return SizedBox(
      ...
      child: Column(
        ...
        children: [
          ...
          textWidget(
            'Escolha o tema e automaticamente iremos trocar para você',
            fontSize: 2.5.h,
            autoSize: false,
            maxLines: 10,
